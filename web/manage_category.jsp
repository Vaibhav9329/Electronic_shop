<%-- 
    Document   : view_added_category
    Created on : 7 Mar, 2023, 3:56:53 PM
    Author     : acer
--%>
                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <a href="http://localhost:8080/Electronics_shop/add_category.jsp#" class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Add New Category</span></a>						
                            </div>
                        </div>
                    </div>
                    <form action="manage_category.jsp" method="post">
                        <div class="row">
                            <div class="col-sm-12">
                                <input type="text" name="cat_name" placeholder="Cat Name To Search" class="from-control">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <%
                            ...
                            if (event != null) {
                                sql = "select * from tbl_add_category where cat_name='" + name + "' ";
                            } else {
                        ...
                        <form action="update_category.jsp" method="post">
                            ...
                            <td><%=rs.getString("cat_image")%></td>
                            <input type="hidden" name="img" value="<%=rs.getString("cat_image")%>">
                            <td><%=rs.getString("description")%></td>
                            <input type="hidden" name="des" value="<%=rs.getString("description")%>">
                            <td>
