            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    ...
                    <form action="view_users.jsp" method="post">
                        <div class="row">
                            <div class="col-sm-12">
                                <input type="text" name="contact" placeholder="Contact Number To Search" class="from-control">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <%
                            ...
                            if (event != null) {
                                sql = "select * from tbl_user_signup where contact='" + contact + "' ";
                            } else {
                                sql = "select * from tbl_user_signup ";
                            }
